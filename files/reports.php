<?php
//Getting gradings for students
function grade($score)
{
    if ($score >= 65) $grade = 'D1';
    else if ($score <= 64 && $score >= 60) $grade = 'D2';
    else if ($score <= 60 && $score >= 58) $grade = 'C3';
    else if ($score <= 58 && $score >= 55) $grade = 'C4';
    else if ($score <= 54 && $score >= 46) $grade = 'C5';
    else if ($score <= 39 && $score >= 30) $grade = 'C6';
    else if ($score <= 25 && $score >= 20) $grade = 'P7';
    else $grade = 'F9';
    return $grade;
}
?>
<div class="wd mx-auto">
    ...
    if (isset($_GET['printreport'])) {
        ...
        $sql = "SELECT s.id, u.fname, u.lname, c.class FROM student as s join user as u on u.id=s.userid
        join classes as c on c.id = s.class WHERE s.class = '$classId'";
        //echo $sql;
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    while ($subject = $q2->fetch_assoc()) {
                                        ...
                                        $q3 = $db->query($sql) or die($db->error);
                                        $d3 = $q3->fetch_assoc();
